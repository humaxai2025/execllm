...
For the latest information and interactive comparisons, visit execllm.humanxiahome.com
`;
  ...
  const exportToPDF = () => {
    // Create a new window for PDF viewing
    ...
    const htmlContent = `
      ...
      <body>
        ...
        <div class="download-info">
          ...
          Press Ctrl+P (Windows) or Cmd+P (Mac), then select "Save as PDF" as destination
        </div>
